...
# Cinema-Cafe-App<a name="about-project"></a>

Vanilla JS App that displays the information for current Movies and TV shows
...
This project is [MIT](https://github.com/Megagig/Cinema-Cafe-App/blob/development/LICENSE) licensed.
